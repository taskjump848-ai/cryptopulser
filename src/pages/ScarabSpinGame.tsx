...
const ScarabSpinGame: React.FC = () => {
  ...
  const spin = () => {
    ...
    setTimeout(() => {
      ...
      const payouts: Record<number, number> = { 1: 0, 2: 0.5, 3: 3, 4: 12, 5: 60 };
      const mult = payouts[maxRun] || 0;
      setResult({ mult });
      placeBet('Scarab Spin', betAmount, mult, mult > 0);
      setSpinning(false);
    }, 1000);
  };
